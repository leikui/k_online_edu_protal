                  ...
                  <section class="i-teach-wrap">
                    <div class="i-teach-pic">
                      <a href="/teacher/1" title="姚晨">
                        <img :alt="teacher.name" :src="teacher.avatar" :onerror="defaultTeacherImg">
                      </a>
                    </div>
  ...
  export default {
    data () {
      return {
        ...
        hotCourseList: [],
        hotTeacherList: [],
        defaultImg: 'this.src="' + require("~/assets/img/default-img.gif") +'";this.onerror=null',
        defaultTeacherImg: 'this.src="' + require("~/assets/img/avatar-boy.gif") +'";this.onerror=null'
      }
    },
    created() {
      this.getBannerList()
      this.getHotTeacherAndCourse()
    },
    methods: {
      getBannerList(){
        banner.getBanner().then(resp => {
          this.bannerList = resp.data.list
        })
      },
      getHotTeacherAndCourse(){
        index.getIndexData()
          .then(resp => {
            this.hotCourseList = resp.data.hotCourse
            console.log(this.hotCourseList)

            this.hotTeacherList = resp.data.hotTeacher
            console.log(this.hotTeacherList)
          })
      }
    }
  }
